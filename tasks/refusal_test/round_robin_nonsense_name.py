...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_base_dir', type=str, default="/mnt/unium/v-dachengwen/hallulens/round_robin_nonsense_name/output", help='the output base dir of inference and eval results')
    parser.add_argument('--prompt_output_path', type=str, default="/mnt/unium/v-dachengwen/hallulens/round_robin_nonsense_name") # name output
